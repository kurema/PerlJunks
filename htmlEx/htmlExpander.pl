...
sub htmlExpanderCalendarSub{
	...
	$baseText=~ s/{day_w_j}/qw(ÅàE¸E²Ð ÀEÌÚ µàEÅÚ)[getDay($arg[0],$arg[1],$arg[2])]/eg ;
...
sub getLocalTimeHash{
	...
	$TIME{"wDayJapanese"}=qw(ÅàE¸E²Ð ÀEÌÚ µàEÅÚ)[$TIME{"wDay"}];
	...
	$TIME{"mDayJapanese"}=qw(ËÓ¸EÇ¡¸EËàE·þ±¬¸E»©¸E¿åÌµ¸EÊ¸¸EÍÕ¸EÄ¹¸E¿ÀÌµ¸EÁú¸E¿À³Ú¸E»ÕÂE[$TIME{"month"}];
	...
	$TIME{"textTimeJapanese"}=sprintf("%02d\»þ%02dÊ¬%02dÉÃ",$TIME{"hour"},$TIME{"min"},$TIME{"sec"});
